...
public class RecordPerPageDropdown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//body/div[3]/div[1]/div[5]/div[2]/form[1]/fieldset[1]/div[2]/div[1]/div[1]/div[1]/label[1]/div[1]")).click();
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//body/div[3]/div[1]/div[5]/div[2]/form[1]/fieldset[1]/div[2]/div[1]/div[1]/div[1]/label[1]/div[1]")).click();
		Thread.sleep(2000);
		WebElement value2 = driver.findElement(By.xpath("//li[contains(text(),'50')]"));           //select one value "50" in dropdown.
		value2.click();
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("//body/div[3]/div[1]/div[5]/div[2]/form[1]/fieldset[1]/div[2]/div[1]/div[1]/div[1]/label[1]/div[1]")).click();
		Thread.sleep(2000);
		WebElement value3 = driver.findElement(By.xpath("//li[contains(text(),'100')]"));           //select one value "100" in dropdown.
		value3.click();
		Thread.sleep(1000);
