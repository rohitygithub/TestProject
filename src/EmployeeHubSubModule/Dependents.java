...
public class Dependents {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Click on Add New Dependent Detail button
		...
		Thread.sleep(1000);
		//Select one name
		WebElement Req =driver.findElement(By.xpath("//li[contains(text(),'gspl')]"));
		Req.click();
		Thread.sleep(1000);
		
		//Click and select Employee Full NAme from the dropdown list
		...
		//Click and select relation type from the dropdown list
		driver.findElement(By.xpath("//body[1]/div[3]/div[1]/div[5]/div[2]/form[1]/fieldset[1]/div[1]/div[2]/div[7]/div[1]/div[1]/a[1]")).click();
		Thread.sleep(1000);
		//Select one name
		WebElement RT =driver.findElement(By.xpath("//li[contains(text(),'Brother')]"));
		RT.click();
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("//input[@id='lastName']")).sendKeys("Yelamkar");
		Thread.sleep(1000);
